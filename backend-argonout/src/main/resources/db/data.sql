-- Users
INSERT INTO users (user_id, username, email, password_hash, first_name, last_name, role, points) VALUES
                                                                                                     ('b39289b0-b88a-4f09-b8fd-38ab15071acf', 'janek_kowalski', 'janek.kowalski@example.com', 'hashed_password1', 'Jan', 'Kowalski', 'USER', 10),
                                                                                                     ('b3683311-a2e5-4546-b3e3-742f303b2d13', 'anna_nowak', 'anna.nowak@example.com', 'hashed_password2', 'Anna', 'Nowak', 'ADMIN', 20),
                                                                                                     ('46c520c6-8467-437b-9518-8126bc49cbd8', 'piotr_wisniewski', 'piotr.wisniewski@example.com', 'hashed_password3', 'Piotr', 'Wiśniewski', 'USER', 30),
                                                                                                     ('d42e011d-966c-4e16-837f-0e7f3952c039', 'katarzyna_lewandowska', 'katarzyna.lewandowska@example.com', 'hashed_password4', 'Katarzyna', 'Lewandowska', 'USER', 40),
                                                                                                     ('fc93bedd-290d-4061-8e39-4eeeb073190e', 'pawel_zielinski', 'pawel.zielinski@example.com', 'hashed_password5', 'Paweł', 'Zieliński', 'USER', 50);
...
-- Places
INSERT INTO places (place_id, name, description, latitude, longitude, qr_code) VALUES
                                                                                   ...
                                                                                   ('91a1aed9-47ab-4e9b-9fbf-1c6e7c0d496c', 'Akademia Wychowania Fizycznego', 'Na zdjęciu został ukazany na tyle urodziwy budynek, że kręcono w nim film.', 50.07286, 20.00028),
                                                                                   ('f2ca8751-56c2-4a35-a70b-3cc2e7341c1f', 'Politechnika Krakowska', 'Największa politechnika w Krakowie i jej najwybitniejszy wydział, na którym aktualnie się znajmujemy-WIEiK.', 50.07099, 19.94305),
                                                                                   ('273f5a8d-9359-4126-a169-f68e80e1d798', 'Akademia Górniczo-Hutnicza', 'Arcywróg politechniki, ale właśnie tutaj chcielibyśmy iść na studia magisterskie.', 50.06453, 19.92361, 'QR_CODE_AGH'),
...
INSERT INTO threads (thread_id, title, created_by, created_at, updated_at) VALUES
                                                                               ('95ca8fa9-47f1-4c7d-8b7a-2d96225d738a', 'Propozycja dodania trasy', '95ca8fa9-47f1-4c7d-8b7a-2d96225d738a', '2024-07-27 08:00:00', '2024-07-27 08:00:00'),
                                                                               ('01fae080-a036-46ae-80f1-d16316b61ad7', 'Ulubione miejsca w mieście', '95ca8fa9-47f1-4c7d-8b7a-2d96225d738a', '2024-07-27 09:00:00', '2024-07-27 09:00:00');
...
INSERT INTO points_of_users (user_id, points, period) VALUES
    ('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 1020, '2024-07-27'),
    ('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 980, '2024-06-30'),
    ('a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 660, '2024-05-31'),
    ('b39289b0-b88a-4f09-b8fd-38ab15071acf', 810, '2024-07-27'),
    ('b3683311-a2e5-4546-b3e3-742f303b2d13', 620, '2024-07-27'),
...
-- Users_Leagues
INSERT INTO leagues_of_users (user_id, league_id, assigned_at) VALUES
